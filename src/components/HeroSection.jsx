    ...
    <section className="hero">
      <div className="hero__container">
        ...
        <div className="hero__right">
          <button className="tile tile--cta" onClick={onScrollToBrowse}>
            바로 보호소 동물 입양하러 가기
          </button>
          <button className="tile tile--cta" onClick={onRightTile}>
            보호소 동물 추천받기(다른 페이지)
          </button>
        </div>
      </div>
