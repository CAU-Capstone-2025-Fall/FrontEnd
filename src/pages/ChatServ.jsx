...
import { useChatServStore } from '../store/chatServStore'; // ✅ 외부 스토어 가져오기

export default function ChatServ() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-pink-50 to-rose-100 p-6">
      {/* 🐱 고양이 본체 */}
      <motion.div
        ref={botRef}
